...
export const CoreActionsSection = () => {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-jess-subtle/50 transition-all duration-300 hover:shadow-xl relative overflow-hidden group h-full">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Link to="/my-story" className="block aspect-square">
            <div className="bg-gradient-to-br from-jess-subtle/80 to-white rounded-lg h-full p-4 flex flex-col items-center justify-center cursor-pointer shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-br hover:from-jess-secondary/60 hover:to-white border border-jess-subtle/30 hover:border-jess-secondary/50">
              <div className="text-jess-primary mb-2">
                <Book size={isMobile ? 20 : 24} className="transition-transform duration-300 hover:scale-110" />
              </div>
              <h3 className="text-center font-medium text-xl md:text-2xl">My Story</h3>
              <p className="text-sm md:text-base text-center text-jess-muted mt-1 max-w-full break-words">Chat about your journey</p>
            </div>
          </Link>
          ...
          <Link to="/side-quest" className="block aspect-square">
            <div className="bg-gradient-to-br from-jess-subtle/80 to-white rounded-lg h-full p-4 flex flex-col items-center justify-center cursor-pointer shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-br hover:from-jess-secondary/60 hover:to-white border border-jess-subtle/30 hover:border-jess-secondary/50">
              <div className="text-jess-primary mb-2">
                <MessageSquare size={isMobile ? 20 : 24} className="transition-transform duration-300 hover:scale-110" />
              </div>
              <h3 className="text-center font-medium text-xl md:text-2xl">Side Quest</h3>
              <p className="text-sm md:text-base text-center text-jess-muted mt-1 max-w-full break-words">Explore a new topic</p>
            </div>
          </Link>
