  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-jess-subtle/50 transition-all duration-300 hover:shadow-xl relative overflow-hidden group">
      ...
      <div className="relative z-10">
        <h2 className="text-2xl md:text-3xl font-medium mb-5 bg-gradient-to-r from-jess-primary to-jess-foreground bg-clip-text text-transparent">Core Actions</h2>
        <div className="grid grid-cols-2 gap-4">
          <Link to="/my-story" className="block aspect-square">
            <div className="bg-gradient-to-br from-jess-subtle/80 to-white rounded-lg h-full p-4 flex flex-col items-center justify-center cursor-pointer shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-br hover:from-jess-secondary/60 hover:to-white border border-jess-subtle/30 hover:border-jess-secondary/50">
              <div className="text-jess-primary mb-2">
                <Book size={isMobile ? 32 : 28} className="transition-transform duration-300 hover:scale-110" />
              </div>
              <h3 className={`text-center font-medium ${isMobile ? 'text-base md:text-lg' : 'text-lg'}`}>My Story</h3>
              <p className={`${isMobile ? 'text-xs md:text-sm' : 'text-sm'} text-center text-jess-muted mt-1 max-w-full break-words`}>Chat about your journey</p>
            </div>
          </Link>
          ...
          <Link to="/side-quest" className="block aspect-square">
            <div className="bg-gradient-to-br from-jess-subtle/80 to-white rounded-lg h-full p-4 flex flex-col items-center justify-center cursor-pointer shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-br hover:from-jess-secondary/60 hover:to-white border border-jess-subtle/30 hover:border-jess-secondary/50">
              <div className="text-jess-primary mb-2">
                <MessageSquare size={isMobile ? 32 : 28} className="transition-transform duration-300 hover:scale-110" />
              </div>
              <h3 className={`text-center font-medium ${isMobile ? 'text-base md:text-lg' : 'text-lg'}`}>Side Quest</h3>
              <p className={`${isMobile ? 'text-xs md:text-sm' : 'text-sm'} text-center text-jess-muted mt-1 max-w-full break-words`}>Explore a new topic</p>
            </div>
          </Link>
          ...
          <Link to="/journal" className="block aspect-square">
            <div className="bg-gradient-to-br from-jess-subtle/80 to-white rounded-lg h-full p-4 flex flex-col items-center justify-center cursor-pointer shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-br hover:from-jess-secondary/60 hover:to-white border border-jess-subtle/30 hover:border-jess-secondary/50">
              <div className="text-jess-primary mb-2">
                <FilePlus size={isMobile ? 32 : 28} className="transition-transform duration-300 hover:scale-110" />
              </div>
              <h3 className={`text-center font-medium ${isMobile ? 'text-base md:text-lg' : 'text-lg'}`}>New Entry</h3>
              <p className={`${isMobile ? 'text-xs md:text-sm' : 'text-sm'} text-center text-jess-muted mt-1 max-w-full break-words`}>Write freely</p>
            </div>
          </Link>
          ...
          <Link to="/journal-challenge" className="block aspect-square">
            <div className="bg-gradient-to-br from-jess-subtle/80 to-white rounded-lg h-full p-4 flex flex-col items-center justify-center cursor-pointer shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:bg-gradient-to-br hover:from-jess-secondary/60 hover:to-white border border-jess-subtle/30 hover:border-jess-secondary/50">
              <div className="text-jess-primary mb-2">
                <PenLine size={isMobile ? 32 : 28} className="transition-transform duration-300 hover:scale-110" />
              </div>
              <h3 className={`text-center font-medium ${isMobile ? 'text-base md:text-lg' : 'text-lg'}`}>Journal</h3>
              <p className={`${isMobile ? 'text-xs md:text-sm' : 'text-sm'} text-center text-jess-muted mt-1 max-w-full break-words`}>Guided prompt</p>
            </div>
          </Link>
        </div>
      </div>
