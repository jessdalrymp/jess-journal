...
export const CoreActionsSection = () => {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-xl p-2 shadow-lg border border-jess-subtle/50 transition-all duration-300 hover:shadow-xl relative overflow-hidden group">
      ...
      <div className="relative z-10">
        <h2 className="text-2xl md:text-3xl font-medium mb-2 bg-gradient-to-r from-jess-primary to-jess-foreground bg-clip-text text-transparent">Dashboard</h2>
        <div className="grid grid-cols-2 gap-2">
          <Link to="/my-story" className="block">
            <div className="bg-gradient-to-br from-jess-subtle/80 to-white rounded-lg p-2 h-16 flex flex-col items-center justify-center cursor-pointer shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 hover:bg-gradient-to-br hover:from-jess-secondary/60 hover:to-white border border-jess-subtle/30 hover:border-jess-secondary/50">
              <div className="text-jess-primary mb-0.5">
                <Book size={isMobile ? 18 : 16} className="transition-transform duration-300 hover:scale-110" />
              </div>
          ...
          <Link to="/side-quest" className="block">
            <div className="bg-gradient-to-br from-jess-subtle/80 to-white rounded-lg p-2 h-16 flex flex-col items-center justify-center cursor-pointer shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 hover:bg-gradient-to-br hover:from-jess-secondary/60 hover:to-white border border-jess-subtle/30 hover:border-jess-secondary/50">
              <div className="text-jess-primary mb-0.5">
                <MessageSquare size={isMobile ? 18 : 16} className="transition-transform duration-300 hover:scale-110" />
              </div>
          ...
          <Link to="/journal" className="block">
            <div className="bg-gradient-to-br from-jess-subtle/80 to-white rounded-lg p-2 h-16 flex flex-col items-center justify-center cursor-pointer shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 hover:bg-gradient-to-br hover:from-jess-secondary/60 hover:to-white border border-jess-subtle/30 hover:border-jess-secondary/50">
              <div className="text-jess-primary mb-0.5">
                <FilePlus size={isMobile ? 18 : 16} className="transition-transform duration-300 hover:scale-110" />
              </div>
          ...
          <Link to="/journal-challenge" className="block">
            <div className="bg-gradient-to-br from-jess-subtle/80 to-white rounded-lg p-2 h-16 flex flex-col items-center justify-center cursor-pointer shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 hover:bg-gradient-to-br hover:from-jess-secondary/60 hover:to-white border border-jess-subtle/30 hover:border-jess-secondary/50">
              <div className="text-jess-primary mb-0.5">
                <PenLine size={isMobile ? 18 : 16} className="transition-transform duration-300 hover:scale-110" />
              </div>
