...
export const PricingPlan = ({ 
  ...
  return (
    <div className="grid md:grid-cols-2 gap-6">
      ...
      {/* Annual Plan */}
      <div className="bg-white border-2 border-green-500 rounded-lg p-6 shadow-md relative">
        ...
        <p className="text-sm text-green-600 mb-4">That's just $8.25/month - Save over $80 a year!</p>
