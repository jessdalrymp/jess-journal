  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-center mb-8">Your Path to Authentic Growth</h2>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="space-y-8">
            <Step
              ...
              description="Simply begin sharing your thoughts. JESS listens deeply."
            />
            
            <Step
              number={2}
              title="Receive Personalized Reflections"
              description="JESS analyzes your words and offers insights that genuinely resonate."
            />
            
            <Step
              number={3}
              title="Rewrite Your Story"
              description="Embrace lasting transformation guided by your true self."
            />
          </div>
        </div>
